...
export function HeroSpline() {
  return (
    <div className="w-full relative flex flex-col md:flex-row items-center justify-between min-h-[480px] md:min-h-[520px] gap-8 md:gap-4 overflow-visible">
      ...
      <div className="w-full md:w-[52%] z-10 flex flex-col justify-center order-2 md:order-1 text-left">
        ...
        <div className="flex flex-row items-center gap-3.5 sm:gap-4 mt-6 sm:mt-8">
          <Link
            href="/games/escape-the-forest"
            className="h-11 px-6 rounded-lg text-sm sm:text-base font-medium shadow-sm transition-all duration-200 inline-flex items-center justify-center bg-slate-900 text-white hover:bg-slate-800 dark:bg-white dark:text-slate-900 dark:hover:bg-slate-100"
          >
            Explore Games
          </Link>
          <Link
            href="/education/physics"
            className="h-11 px-6 rounded-lg text-sm sm:text-base font-medium transition-all duration-200 inline-flex items-center justify-center border border-slate-300 dark:border-slate-800 bg-transparent text-foreground hover:bg-slate-100 dark:hover:bg-slate-800/70"
          >
            Start Learning
          </Link>
        </div>
      ...
      <div className="w-full md:w-[48%] h-[320px] sm:h-[400px] md:h-[480px] relative order-1 md:order-2 flex items-center justify-center overflow-visible">
        <SplineScene 
